...
```{r setup}
rm(list=ls())
setwd("~/GitHub/danger.signal/scripts/GrowthCurves")
knitr::opts_knit$set(root.dir = "~/GitHub/danger.signal/scripts/GrowthCurves")
...
require("MuMIn")
require("bbmle")
source("~/GitHub/danger.signal/scripts/GrowthCurves/bin/modified_Gomp_diagnostic3.R")
...
gfp <- read.csv("~/GitHub/danger.signal/scripts/GrowthCurves/data/20250213_spo0agfp_gfp_reads.csv")
...
gfp.DSM.controls_avg.2 <- growth.modGomp(input = gfp.DSM.controls_avg, output.name = "gfp.DSM.controls_avg.2.parms",
...
gfp_cDSM_controls.out.1 <- read.table("~/GitHub/danger.signal/scripts/GrowthCurves/output/gfp.cDSM.controls.1.parms.txt", sep = ",", header=TRUE)
...
gfp_cDSM_BBphage.out.1 <- read.table("~/GitHub/danger.signal/scripts/GrowthCurves/output/gfp.cDSM.BBphage.1.parms.txt", sep = ",", header=TRUE)
```
...
# Assuming your data frame is called 'merged_lag_metadata'
# and it contains 'lag_time' as the dependent variable and 'Curve' as the treatment group
